Shader "Hidden/Locked/.poiyomi/Poiyomi 8.2/Poiyomi Pro World/8fa89bd979c194a43a14e7a2caa11175"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
				poiMesh.tangentSpaceNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_BumpMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_BumpMapUV*/)].xy, float4(400,400,0,0)), float4(0,0,0,0), (0.0 /*_BumpMapStochastic*/)), (3.0 /*_BumpScale*/));
				#else
