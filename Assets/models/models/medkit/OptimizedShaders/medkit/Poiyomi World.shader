Shader "Hidden/Locked/.poiyomi/Poiyomi 8.2/Poiyomi World/1300ead1d3a3af64dbe6660745ea4002"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.194 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.123 /*_MatcapMultiply*/), (0.248 /*_MatcapReplace*/), (0.194 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/));
				#endif
			}
			#endif
