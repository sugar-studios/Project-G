Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro/c7a441c0269acdd4aacc69ca4725021a"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyTPSPenetrator(inout float4 vertex, inout float3 normal, inout float4 vertexColor, uint vertexId, float2 uv) {
				...
				if (bezierStrength > 0) {
					...
					float squeeze = lerp(0, (0.0 /*_TPS_Squeeze*/), saturate(penetrationDepth * 20));
					sizeChange *= lerp(1, 1 - squeeze, saturate(1 - abs(bezierStrengthUncapped - 1) / (0.01 /*_TPS_SqueezeDistance*/)) * tpsSmoothStart);
					sizeChange *= lerp(1, 1 + (0.0 /*_TPS_Buldge*/), buldgeLerp * tpsSmoothStart2);
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.0 /*_MatcapMultiply*/), (1.0 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/));
				#endif
			}
			#endif
